...
g++ -o mediatest -Wall -DWITH_OPENSSL -DWITH_DOM -DWITH_ZLIB \
  -I. -I ../include/plugin -I ../include/custom -I ../include -I ../include/soapProxy -I ../samples/common -I ../samples/mediatest \
