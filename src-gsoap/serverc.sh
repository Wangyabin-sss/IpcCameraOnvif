...
case $1 in
	"h")
		wsdl2h -O4 -P -c -x -s -t public/typemap.dat -o serverc/onvif.h \
		http://www.onvif.org/onvif/ver10/device/wsdl/devicemgmt.wsdl \
  ...
  http://www.onvif.org/onvif/ver10/network/wsdl/remotediscovery.wsdl
		...
		;;
	"c")
		soapcpp2 -2 -c -S -L -d serverc -I ../gsoap-2.8/gsoap/import -I ../gsoap-2.8/gsoap -x serverc/onvif.h
		soapcpp2 -a -c -S -x -d serverc -L -pwsdd -I ../gsoap-2.8/gsoap/import ../gsoap-2.8/gsoap/import/wsdd5.h
		;;
esac
