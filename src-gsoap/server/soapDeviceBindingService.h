...
#include "soapH.h"
    ...
    class SOAP_CMAC DeviceBindingService {
      public:
        ...
        //
        /// Web service operation 'GetPasswordComplexityOptions' implementation, should return SOAP_OK or error code
        virtual int GetPasswordComplexityOptions(_tds__GetPasswordComplexityOptions *tds__GetPasswordComplexityOptions, _tds__GetPasswordComplexityOptionsResponse &tds__GetPasswordComplexityOptionsResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetPasswordComplexityConfiguration' implementation, should return SOAP_OK or error code
        virtual int GetPasswordComplexityConfiguration(_tds__GetPasswordComplexityConfiguration *tds__GetPasswordComplexityConfiguration, _tds__GetPasswordComplexityConfigurationResponse &tds__GetPasswordComplexityConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'SetPasswordComplexityConfiguration' implementation, should return SOAP_OK or error code
        virtual int SetPasswordComplexityConfiguration(_tds__SetPasswordComplexityConfiguration *tds__SetPasswordComplexityConfiguration, _tds__SetPasswordComplexityConfigurationResponse &tds__SetPasswordComplexityConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetPasswordHistoryConfiguration' implementation, should return SOAP_OK or error code
        virtual int GetPasswordHistoryConfiguration(_tds__GetPasswordHistoryConfiguration *tds__GetPasswordHistoryConfiguration, _tds__GetPasswordHistoryConfigurationResponse &tds__GetPasswordHistoryConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'SetPasswordHistoryConfiguration' implementation, should return SOAP_OK or error code
        virtual int SetPasswordHistoryConfiguration(_tds__SetPasswordHistoryConfiguration *tds__SetPasswordHistoryConfiguration, _tds__SetPasswordHistoryConfigurationResponse &tds__SetPasswordHistoryConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetAuthFailureWarningOptions' implementation, should return SOAP_OK or error code
        virtual int GetAuthFailureWarningOptions(_tds__GetAuthFailureWarningOptions *tds__GetAuthFailureWarningOptions, _tds__GetAuthFailureWarningOptionsResponse &tds__GetAuthFailureWarningOptionsResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetAuthFailureWarningConfiguration' implementation, should return SOAP_OK or error code
        virtual int GetAuthFailureWarningConfiguration(_tds__GetAuthFailureWarningConfiguration *tds__GetAuthFailureWarningConfiguration, _tds__GetAuthFailureWarningConfigurationResponse &tds__GetAuthFailureWarningConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'SetAuthFailureWarningConfiguration' implementation, should return SOAP_OK or error code
        virtual int SetAuthFailureWarningConfiguration(_tds__SetAuthFailureWarningConfiguration *tds__SetAuthFailureWarningConfiguration, _tds__SetAuthFailureWarningConfigurationResponse &tds__SetAuthFailureWarningConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
