...
PullPointSubscriptionBindingService::~PullPointSubscriptionBindingService()
{	if (this->soap_own)
	{	PullPointSubscriptionBindingService::destroy();
		soap_free(this->soap);
	}
}
...
static int serve___tev__AddEventBroker(struct soap*, PullPointSubscriptionBindingService*);
static int serve___tev__DeleteEventBroker(struct soap*, PullPointSubscriptionBindingService*);
static int serve___tev__GetEventBrokers(struct soap*, PullPointSubscriptionBindingService*);
...
int PullPointSubscriptionBindingService::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "tev:AddEventBroker"))
		return serve___tev__AddEventBroker(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tev:DeleteEventBroker"))
		return serve___tev__DeleteEventBroker(soap, this);
	if (!soap_match_tag(soap, soap->tag, "tev:GetEventBrokers"))
		return serve___tev__GetEventBrokers(soap, this);
...
static int serve___tev__AddEventBroker(struct soap *soap, PullPointSubscriptionBindingService *service)
{	struct __tev__AddEventBroker soap_tmp___tev__AddEventBroker;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->AddEventBroker(soap_tmp___tev__AddEventBroker.tev__AddEventBroker, tev__AddEventBrokerResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
...
static int serve___tev__DeleteEventBroker(struct soap *soap, PullPointSubscriptionBindingService *service)
{	struct __tev__DeleteEventBroker soap_tmp___tev__DeleteEventBroker;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->DeleteEventBroker(soap_tmp___tev__DeleteEventBroker.tev__DeleteEventBroker, tev__DeleteEventBrokerResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
...
static int serve___tev__GetEventBrokers(struct soap *soap, PullPointSubscriptionBindingService *service)
{	struct __tev__GetEventBrokers soap_tmp___tev__GetEventBrokers;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->GetEventBrokers(soap_tmp___tev__GetEventBrokers.tev__GetEventBrokers, tev__GetEventBrokersResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
