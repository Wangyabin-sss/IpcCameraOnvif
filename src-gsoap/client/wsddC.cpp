...
SOAP_SOURCE_STAMP("@(#) wsddC.cpp ver 2.8.122 2022-09-01 06:02:50 GMT")
...
{	(void)tag;
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in client/wsddC.cpp\n", tag ? tag : "", type));
